...
LU19:
%v41 = phi i32 [ 0, %LU17 ], [ %v51, %LU23 ]
%v42 = phi i32 [ %v39, %LU17 ], [ %v52, %LU23 ]
...
%v46 = call i32 @prime(i32 %v41)
%v47 = trunc i32 %v46 to i1
br i1 %v47, label %LU22, label %LU23
...
LU23:
%v50 = phi i32 [ %v41, %LU22 ], [ %v41, %LU20 ]
%v52 = phi i32 [ %v42, %LU22 ], [ %v42, %LU20 ]
